    ...
    internal class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            */
            ...
            string aktiivsus = Console.ReadLine();

            double bmr = ToiduaindeFunc.KaloriteArvutamine(weight, height, age, gender);
            double paevaKalorid = ToiduaindeFunc.KaloriteArvutaminePaevas(bmr, aktiivsus);

            Console.WriteLine($"Teie päevane kaloraaž on: {paevaKalorid.ToString("F0")} kalorit.");
            ...
            {
                double portion = ToiduaindeFunc.Toiduportsion(paevaKalorid, food.Value);
                Console.WriteLine($"{food.Key}: {portion.ToString("F0")} grammi");
            }
