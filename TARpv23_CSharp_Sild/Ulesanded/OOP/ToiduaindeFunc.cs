...
namespace TARpv23_CSharp_Sild.Ulesanded.OOP
{
    ...
    {
        public static double KaloriteArvutamine(double weight, double height, int age, string gender)
        {
        ...
        public static double KaloriteArvutaminePaevas(double bmr, string aktiivsus)
        {
            switch (aktiivsus.ToLower())
            {
                case "istuv":
                    return bmr * 1.2;
                case "vähene":
        ...
        public static double Toiduportsion(double paevaKalorid, double toiduKalorid)
        {
            return paevaKalorid / toiduKalorid;
        }
    }
}